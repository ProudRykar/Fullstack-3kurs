...
from app.monitoring.prometheus_mongo import (
    MONGO_OPS,
    MONGO_LATENCY,
    MONGO_ERRORS,
    MONGO_ACTIVE_CONN,
    monitored_mongo_call,
)
from app.monitoring.prometheus_redis import (
    REDIS_OPS,
    REDIS_LATENCY,
    REDIS_ERRORS,
    monitor_redis,
...
HTTP_ERRORS = Counter(
    "app_http_errors", "HTTP requests resulting in errors", ["method", "path", "status"]
)
